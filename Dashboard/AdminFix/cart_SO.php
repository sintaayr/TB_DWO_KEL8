...
$query = "SELECT sum(revenue) as TotalRevenue from fact_table group by specialofferid;";
...
$query = "SELECT description from specialoffer;";
$result = mysqli_query($connect, $query);
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Charts Special Offer</h1>
                    ...
                    <a style="margin-bottom: 30px;" href="SO.php" class="btn btn-success btn-icon-split">
