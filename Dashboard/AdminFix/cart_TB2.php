...
$query = "SELECT product.name, coalesce(sum(ft_bestsellingproduct.total_penjualan),0) as TotalPenjualan
        from product 
        left join ft_bestsellingproduct on product.product_id=ft_bestsellingproduct.product_id                                                   
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Best Selling Product Charts</h1>
                        ...
                        <div class="col-xl-12 col-lg-11">                        
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <hr>
                                    <!-- Styling for the line chart can be found in the -->
                                    <!-- <code>/js/demo/chart-bar-demo.js</code> file. -->
                                </div>
                            </div>
                        </div>                        
                    </div>
                    <a style="margin-bottom: 30px;" href="TB2.php" class="btn btn-success btn-icon-split">
