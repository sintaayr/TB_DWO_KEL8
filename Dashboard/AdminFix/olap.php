            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">OLAP USING MONDRIAN</h1>
                    </div>

                    <div class="container-olap">
                        <p>
                        Berikut merupakan tampilan OLAP dari database Adventurework yang di integrasikan dengan Mondrian.
                        </p>                        
                        <br>
                        <iframe style="width: 100%; height: 400px;" name="mondrian" src="http://localhost:8080/mondrian"></iframe>
                        <br>
                    </div>
                </div>
        </div>
